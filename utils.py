...
def init_mail(app):
    ...
    app.config['MAIL_USERNAME'] = 'nikhilbanala28k@gmail.com'  # Replace
    app.config['MAIL_PASSWORD'] = 'rzfpzdjropifpmhs'     # Replace
    app.config['MAIL_DEFAULT_SENDER'] = ('LifeTag OTP', 'nikhilbanala28k@gmail.com')
    mail.init_app(app)
